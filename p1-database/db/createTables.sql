...
ALTER TABLE ALBUMS
ADD CONSTRAINT COVER_PHOTO_OF_ALBUM
FOREIGN KEY (COVER_PHOTO_ID) REFERENCES PHOTOS(PHOTO_ID)
INITIALLY DEFERRED DEFERRABLE;

ALTER TABLE PHOTOS
ADD CONSTRAINT ALBUM_OF_PHOTOO
...
CREATE SEQUENCE seq_city START WITH 1
INCREMENT BY 1;
...
CREATE TRIGGER add_prg BEFORE INSERT ON PROGRAMS FOR EACH ROW
BEGIN
